...
https://github.com/lleokaganov/lleoblog-min

Это минимальная конфигурация файлов для запуска движка, а основной проект: https://github.com/lleokaganov/lleoblog

В каких случаях нужна минимальная конфигурация?
    1) Если вы хотите установить движок в минимальной конфигурации чтобы настроить и убедиться в работоспособности,
	а затем воспользоваться возможностями веб-инсталлятора (в /install) чтобы вытянуть все остальные файлы (кроме внешних пакетов /extended)

    2) Если вы хотите использовать основной фреймворк движка и его систему авторизации, чтобы на этой базе создавать веб-проекты, не имеющие отношения к ведению сайта или блога.
	Например, я делаю на этой базе разные индустриальные проекты и сайты, где не нужны заметки, страницы, комментарии, автопостинги и прочая медийная движуха.
