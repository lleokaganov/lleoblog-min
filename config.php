...
$admin_unics="26"; // сюда надо будет вписать через запятую номера админов после установки движка, скорее всего вы будете первым и получите номер 1
...
$hashinput = "M87Ui4fp2YCs9aMFQ0EOnqe2xYb7Lr8S8lrYXowJFVpIB4c97rkJOG0lJ7lFn_A8NJANgFtgdw763wzOWR1qgGsFiVPc0S2VQl9Wr7sJODUyghmwTTUj3SuF6BAKUlPJ"; // строка для вывода хэшиков каждой страницы и паролит оно же секретные линки
$hashlogin = "2IKmjAPUNu9JGZX4ns21rOea4_QqkDMPkrCeAQ6BUD4LIxP5Q3dIAPw4F00HKM9qR3qEt8dP6L02dfrYQClNcYSLAfmflHRG4muyG6QZYNhybn2Jw1njuUZ6dTT2eTA9"; // строка бп
$hashrss = "8eJQq9zvOaB4YMv5XdkeKAIViE4z_Het3t1XlBKc76Z2xf1WjJTlBmxzGfN2T10EW7t9S0oaajOWXep_AR4AD_8XB9JkMNAbMNWhdnZ5C06rXQADgo1q1a_L0Qs2WRvd"; // hash для rss-ленты

# $HTTPS_REDIRECT=1; // перекидывать все обращения http на https

$httpsite = $HTTPS."://".$_SERVER['HTTP_HOST'];
$blogdir = "min/"; // имя папки блога при установке движка не в корень, например "dnevnik/", если движок в корне сайте - оставить пустым
...
// $db_fkey="`lleoblog`.`fkey`"; // имя базы ключей, устаревшая фича, не используется
...
$rekomenda_pass="blagovest"; // пароль для модуля REKOMENDA
...
# режим работы движка
$mnogouser=0; // многопользовтаельский режим
...
// $realdom='kz'; // домен прямого обращения ClawdFlare

# $sendmail_service_pass='muha'; $sendmail_gate_pass='SyuajsyeE'; // разрешить использовать почтовую систему двитжка для сторонних систем почтовых рассылок
# $flatlogin='root'; $flatpassword='KuliBuli'; // разрешить авторизованный постинг в мой блог по протоколу ЖЖ flat
# $uploadpassword='KruSiu'; // для /backup

# $db_rekomenda = "`lleoblog`.`rekomenda`"; // имя базы рекомендаций
